...
fields = Comma-separated values. Feel free to add / remove fields to your liking. There will always be the fields "id", "key", "status", and "updated", which serve as default.
